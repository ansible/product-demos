...
|----------|----------|-------------|
| OpenShift ǀ GitLab ǀ Install | [`openshift/gitlab.yml`](../gitlab.yml) | Installs cert-manager, deploys the GitLab operator, and creates a GitLab instance on OpenShift |

## Related demos

| Demo | Description |
|------|-------------|
| ⎈ [Dev Spaces](./openshift-dev-spaces.md) | Install Dev Spaces alongside GitLab for a complete developer platform |
