...
/**
 * Custom header for the GoKEV ansible wordpress
 */
...
function twentyseventeen_custom_header_setup() {
	...
	add_theme_support(
		...
		apply_filters(
			...
			array(
				'default-image'    => get_parent_theme_file_uri( '/assets/images/header.jpg?' . substr(str_shuffle('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),1,15) ),
				'width'            => 2000,
				'height'           => 1200,
				'flex-height'      => true,
				'video'            => true,
